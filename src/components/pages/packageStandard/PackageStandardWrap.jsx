        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              <PackageCardGamma
                image={'/images/package/p-gumma1.png'}
              ...
              />
              <PackageCardGamma
                image={'/images/package/p-gumma6.png'}
                cardLavel="3 Day &amp; 2 night"
